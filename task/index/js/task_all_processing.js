...
function initData(){
    ...
    var dataObj=null;
    if(queryParam!=""){
        dataObj={"pageNum":pageNum,"pageSize":pageSize,"disposeState":"20","queryCondition":queryParam};
    }else{
        dataObj={"pageNum":pageNum,"pageSize":pageSize,"disposeState":"20"};
    }
        ...
        if(data_all.length==0){
            ...
            for (var i = 0; i < data_all.length; i++) {
                ...
                _item.title = '<div class="event_list us1" onclick="enter_list(this);">' +
                    ...
                    '<input type="hidden" name="disposeTime" value="' + data_all[i].disposeTime + '" />' +
