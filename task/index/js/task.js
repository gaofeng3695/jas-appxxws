...
appcan.ready(function() {
    ...
    appcan.frame.open("content", "task_content.html", 0, titHeight,"task_content");
...
appcan.button("#nav-right","btn-act", function() {
    ...
    appcan.openWinWithUrl("task_all","task_all.html","9","0","200");
    setTimeout(function() {
        appcan.window.close("9","500");
    }, 500); 

    // var titHeight = $('#header').offset().height;
    // var txt=$("#who_task").text();
    // if(txt=='我的任务'){
        // $("#footer").removeClass("ub").hide();
        // resizeWindowSize();
        // $("#who_task").text("全部任务");
        // appcan.frame.close("task_content");
        // appcan.locStorage.setVal("task_content_titHeight", titHeight);
    ...
    // }else{
        ...
        // resizeWindowSize();
        // $("#who_task").text("我的任务");
        // appcan.frame.close("task_all_content");
        // appcan.locStorage.setVal("task_content_titHeight", titHeight);
        // appcan.frame.open("content", "task_content.html", 0, titHeight,"task_content");
    // }
});
