...
Enumerable = function () {
    ...
    c.From = function (j) {
        ...
        return new c(function () {
            var b = [], c = 0;
            return new f(function () {
                for (var a in j)!(j[a]instanceof Function) && b.push({Key: a, Value: j[a]})
            }, function () {
        ...
        CascadeBreadthFirst: function (g, b) {
            ...
            return new c(function () {
                ...
                return new f(function () {
                    ...
                    while (e) {
                        if (i != b)if (i.MoveNext())return this.Yield(i.Current()); else i = b;
            ...
            return new c(function () {
                ...
                return new f(function () {
                    ...
                    var d;
                    while ((d = b.MoveNext()) == e)if (o === h(j(b.Current())))m.push(i(b.Current())); else break;
                    if (m.length > 0) {
            ...
            this.ForEach(function (g) {
                ...
                if (d !== undefined)d.push(a); else e.Add(f, [a])
            });
            return new q(e)
            ...
            var g = e;
            this.ForEach(function (b) {
                if (g)g = a; else document.write(c);
                document.write(f(b))
            })
    ...
    var g = {
        ...
        CreateLambda: function (a) {
            ...
            if (typeof a == i.String)if (a == "")return g.Identity; else if (a.indexOf("=>") == -1)return new Function("$,$$,$$$,$$$$", "return " + a); else {
                var c = a.match(/^[(\s]*([^()]*?)[)\s]*=>(.*)/);
    ...
    var n = function () {
        ...
        j.prototype = {
            AddLast: function (c) {
                ...
                if (a.Prev != b)a.Prev.Next = a.Next; else this.First = a.Next;
                if (a.Next != b)a.Next.Prev = a.Prev; else this.Last = a.Prev
            }
        };
        var k = function (c) {
            var a = this;
