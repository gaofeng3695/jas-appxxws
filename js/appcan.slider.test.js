    ...
    SliderView.prototype = {
        ...
        set: function(data) {
            ...
            if (self.option.hasCircle) {
                ...
                var zamcon = $('<div class="labelcon1" name="labContent" style="margin-right : .5em;float: left;padding: 0.25em;background-color: #b2b2b2;border-radius: 50%;"></div>');
                var zamcon1 = $('<div class="labelcon" name="labContent"></div>');
                for (var tt = 0; tt < self.option.itemCount; tt++) {
                    if (tt == 0) {
                        dian.append(zamcon);
                    } else {
                        dian.append('<div class="labelcon" name="labContent" style="margin-right : .5em;float: left;padding: 0.25em;background-color: #fff;border-radius: 50%;"></div>');
                    }
                }
            ...
            self.ele.off("swipeLeft").on("swipeLeft", function(evt) {
                ...
                for (var i = 0; i < name.length; i++) {
                    if (i == index) {
                        name[i].style.cssText = 'margin-right : .5em;float: left;padding: 0.25em;background-color: #b2b2b2;border-radius: 50%;';
                    } else {
                        name[i].style.cssText = 'margin-right : .5em;float: left;padding: 0.25em;background-color: #fff;border-radius: 50%;';
                    }
                }
                console.log('1' + self.swipe);
                self._moveTo(++self.option.index);
                console.log('2' + self.swipe);
                self.autoMove(self.option.auto);
                console.log('3' + self.swipe);
            });
